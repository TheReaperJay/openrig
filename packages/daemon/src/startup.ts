...
export async function createDaemon(opts?: DaemonOptions): Promise<DaemonResult> {
  ...
  const { probeClaudeAuth, probeCodexAuth, createDefaultAuthExec } = await import("./domain/auth-probe.js");
